# A class module in a workbook opened from disk is named, like one built in the session: loaded
# from disk its module entry carries a different marker and no back-pointer. The committed demo
# is used because no session has loaded it before.
...
try {
    ...
    # the negative control: the standard module in the same workbook
