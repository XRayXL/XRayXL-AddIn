...
'@
     ...
     Expect={ param($t)
        ...
        # the known names, since "a name appeared" is not the same claim
        ...
        $null }
     Calls=@(
        @{ Function='T_N1'; Depth='1'; Parent=-1; Caller='none'; Outcome='returned' }
        @{ Function='T_N2'; Depth='2'; Parent=0; Outcome='returned' }
        @{ Function='T_N3'; Depth='3'; Parent=1; Outcome='returned' } )
