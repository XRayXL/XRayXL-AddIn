...
'@
     ...
     Expect={ param($t)
        ...
        $null }
     # Twice: T_H1C raises, T_H1B catches it. T_H1A saw no error.
     Calls=@(
        @{ Function='T_H1A'; Depth='1'; Parent=-1; Caller='none'; Outcome='returned' }
        @{ Function='T_H1B'; Depth='2'; Parent=0; Outcome='handled' }
        @{ Function='T_H1C'; Depth='3'; Parent=1; Outcome='threw' }
        @{ Function='T_H1B'; Depth='2'; Parent=0; Outcome='handled' }
        @{ Function='T_H1C'; Depth='3'; Parent=3; Outcome='threw' } )
