// Excel C API header: Microsoft's XLCALL.H from the Excel 2013 XLL SDK (version
// 15.0, https://go.microsoft.com/fwlink/?LinkID=251082), used under that SDK's
// licence terms. Microsoft's file begins at its banner below; this note,
// #pragma once and the two includes are the project's.
//
// Kept whole: a hand-trimmed copy once defined xlfGetDef as 183 (xlfProduct)
// instead of 145, and nothing failed loudly.
//
#pragma once
#include <windows.h>
#include <cstdint>
